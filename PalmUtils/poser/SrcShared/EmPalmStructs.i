...
/*
	...
	find •; replace -c ∞ /(∂tDO_TO_FIELD ∂([0-9]«1,1»,)®1[∂t]+(≈)®2/	"®1∂t∂t®2"
	find •; replace -c ∞ /(∂tDO_TO_FIELD ∂([0-9]«2,4»,)®1[∂t]+(≈)®2/	"®1∂t®2"
	
	# Format the second column
	find •; replace -c ∞ /(≈,[∂t]+[_a-z0-9]«1,2»,)®1[∂t]+(≈)®2/		"®1∂t∂t∂t∂t∂t∂t∂t®2"
	find •; replace -c ∞ /(≈,[∂t]+[_a-z0-9]«3,6»,)®1[∂t]+(≈)®2/		"®1∂t∂t∂t∂t∂t∂t®2"
	find •; replace -c ∞ /(≈,[∂t]+[_a-z0-9]«7,10»,)®1[∂t]+(≈)®2/	"®1∂t∂t∂t∂t∂t®2"
	find •; replace -c ∞ /(≈,[∂t]+[_a-z0-9]«11,14»,)®1[∂t]+(≈)®2/	"®1∂t∂t∂t∂t®2"
	find •; replace -c ∞ /(≈,[∂t]+[_a-z0-9]«15,18»,)®1[∂t]+(≈)®2/	"®1∂t∂t∂t®2"
	find •; replace -c ∞ /(≈,[∂t]+[_a-z0-9]«19,22»,)®1[∂t]+(≈)®2/	"®1∂t∂t®2"
	find •; replace -c ∞ /(≈,[∂t]+[_a-z0-9]«23,99»,)®1[∂t]+(≈)®2/	"®1∂t®2"
	
	# Format the third column
	find •; replace -c ∞ /(,[∂t]+[_a-z0-9]«1,2»∂))®5[∂t]+\/		"®5∂t∂t∂t∂t∂t∂t∂t\"
	find •; replace -c ∞ /(,[∂t]+[_a-z0-9]«3,6»∂))®5[∂t]+\/		"®5∂t∂t∂t∂t∂t∂t\"
	find •; replace -c ∞ /(,[∂t]+[_a-z0-9]«7,10»∂))®5[∂t]+\/	"®5∂t∂t∂t∂t∂t\"
	find •; replace -c ∞ /(,[∂t]+[_a-z0-9]«11,14»∂))®5[∂t]+\/	"®5∂t∂t∂t∂t\"
	find •; replace -c ∞ /(,[∂t]+[_a-z0-9]«15,18»∂))®5[∂t]+\/	"®5∂t∂t∂t\"
	find •; replace -c ∞ /(,[∂t]+[_a-z0-9]«19,22»∂))®5[∂t]+\/	"®5∂t∂t\"
	find •; replace -c ∞ /(,[∂t]+[_a-z0-9]«23,99»∂))®5[∂t]+\/	"®5∂t\"
	
	# Format the #define lines
	find •; replace -c ∞ /(∂#define [¬∂t]«1,3»)®1[∂t]+\/		"®1∂t∂t∂t∂t∂t∂t∂t∂t∂t∂t∂t∂t∂t∂t∂t∂t∂t∂t\"
	find •; replace -c ∞ /(∂#define [¬∂t]«4,7»)®1[∂t]+\/		"®1∂t∂t∂t∂t∂t∂t∂t∂t∂t∂t∂t∂t∂t∂t∂t∂t∂t\"
	find •; replace -c ∞ /(∂#define [¬∂t]«8,11»)®1[∂t]+\/		"®1∂t∂t∂t∂t∂t∂t∂t∂t∂t∂t∂t∂t∂t∂t∂t∂t\"
	find •; replace -c ∞ /(∂#define [¬∂t]«12,15»)®1[∂t]+\/		"®1∂t∂t∂t∂t∂t∂t∂t∂t∂t∂t∂t∂t∂t∂t∂t\"
	find •; replace -c ∞ /(∂#define [¬∂t]«16,19»)®1[∂t]+\/		"®1∂t∂t∂t∂t∂t∂t∂t∂t∂t∂t∂t∂t∂t∂t\"
	find •; replace -c ∞ /(∂#define [¬∂t]«20,23»)®1[∂t]+\/		"®1∂t∂t∂t∂t∂t∂t∂t∂t∂t∂t∂t∂t∂t\"
	find •; replace -c ∞ /(∂#define [¬∂t]«24,27»)®1[∂t]+\/		"®1∂t∂t∂t∂t∂t∂t∂t∂t∂t∂t∂t∂t\"
	find •; replace -c ∞ /(∂#define [¬∂t]«28,31»)®1[∂t]+\/		"®1∂t∂t∂t∂t∂t∂t∂t∂t∂t∂t∂t\"
	find •; replace -c ∞ /(∂#define [¬∂t]«32,35»)®1[∂t]+\/		"®1∂t∂t∂t∂t∂t∂t∂t∂t∂t∂t\"
	find •; replace -c ∞ /(∂#define [¬∂t]«36,39»)®1[∂t]+\/		"®1∂t∂t∂t∂t∂t∂t∂t∂t∂t\"
	find •; replace -c ∞ /(∂#define [¬∂t]«40,43»)®1[∂t]+\/		"®1∂t∂t∂t∂t∂t∂t∂t∂t\"
	find •; replace -c ∞ /(∂#define [¬∂t]«44,47»)®1[∂t]+\/		"®1∂t∂t∂t∂t∂t∂t∂t\"
	find •; replace -c ∞ /(∂#define [¬∂t]«48,51»)®1[∂t]+\/		"®1∂t∂t∂t∂t∂t∂t\"
	find •; replace -c ∞ /(∂#define [¬∂t]«52,55»)®1[∂t]+\/		"®1∂t∂t∂t∂t∂t\"
	find •; replace -c ∞ /(∂#define [¬∂t]«56,59»)®1[∂t]+\/		"®1∂t∂t∂t∂t\"
	find •; replace -c ∞ /(∂#define [¬∂t]«60,63»)®1[∂t]+\/		"®1∂t∂t∂t\"
	find •; replace -c ∞ /(∂#define [¬∂t]«64,67»)®1[∂t]+\/		"®1∂t∂t\"
	find •; replace -c ∞ /(∂#define [¬∂t]«68,99»)®1[∂t]+\/		"®1∂t\"
*/
